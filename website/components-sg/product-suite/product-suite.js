              ...
              <div className={styles["products-pointer-content"]}>
                <div className={styles["heading-section"]}>
                  <div className={styles["step-icon"]}>
                    <img
                      className={styles["step-icon-img"]}
                      src="/images/icons/kyc-aadhaar.svg"
                      alt="aadhaar xml"
                    />
                  </div>
          ...
          <div className={styles["payment-collections-pointers"]}>
            ...
            >
              <div className={styles["products-pointer-content"]}>
                ...
                <Link href={urls.SCAN_AND_EXTRACT}>
                  Learn More
                  <FaChevronRight />
                </Link>
              </div>
              ...
              <div className={styles["products-pointer-content"]}>
                <div className={styles["heading-section"]}>
                  <div className={styles["step-icon"]}>
                    <img
                      className={styles["step-icon-img"]}
                      src="/images/icons/kyc-digilocker.svg"
                      alt="digilocker"
                    />
                  </div>
                ...
                <Link href="/resources/digilocker-apis">
