...
const DecentroCareersGallery = dynamic(() =>
  import(
    "../../../components-sg/decentro-careers-gallery/decentro-careers-gallery"
  )
);
const TechStack = dynamic(() =>
  import("../../../components-sg/tech-stack/tech-stack")
);
// Styles Imports
import styles from "../../../styles/page-styles-sg/careers.module.scss";
...
const Careers = () => {
    ...
    block1: [
      {
        ...
        imageSrc: "/images/sg/careers/aws-icon.svg",
      },
      {
        heading: "",
        paragraph: "The persistent data storage for our system",
        imageSrc: "/images/sg/careers/mysql-icon.svg",
      },
      {
        heading: "",
        paragraph: "The basic building block of our codebase",
        imageSrc: "/images/sg/careers/python-icon.svg",
      },
      {
        heading: "",
        paragraph: "The web framework handling all the API calls",
        imageSrc: "/images/sg/careers/flask-icon.svg",
      },
    ],
    block1extra: [
      {
        ...
        imageSrc: "/images/sg/careers/gunicorn-icon.svg",
      },
      {
        heading: "",
        paragraph: "The reverse proxy and the load balancer",
        imageSrc: "/images/sg/careers/nginx-icon.svg",
      },
      {
        heading: "",
        paragraph: "Our framework of choice for the UI",
        imageSrc: "/images/sg/careers/react-icon.svg",
      },
      {
        heading: "",
        paragraph: "The gateway (think Janus) to our multi-environment servers",
        imageSrc: "/images/sg/careers/kong-icon.svg",
      },
    ],
    showOthers: false,
    tagline2: "",
  ...
  const images = [
    {
      original: "/images/sg/careers/team-image-1.jpg",
      thumbnail: "/images/sg/careers/team-image-1.jpg",
    },
    {
      original: "/images/sg/careers/team-image-2.jpg",
      thumbnail: "/images/sg/careers/team-image-2.jpg",
    },
    {
      original: "/images/sg/careers/team-image-3.jpg",
      thumbnail: "/images/sg/careers/team-image-3.jpg",
    },
    {
      original: "/images/sg/careers/team-image-4.jpg",
      thumbnail: "/images/sg/careers/team-image-4.jpg",
    },
    {
      original: "/images/sg/careers/team-image-5.jpg",
      thumbnail: "/images/sg/careers/team-image-5.jpg",
    },
    {
      original: "/images/sg/careers/team-image-6.jpg",
      thumbnail: "/images/sg/careers/team-image-6.jpg",
    },
    {
      original: "/images/sg/careers/team-image-7.jpg",
      thumbnail: "/images/sg/careers/team-image-7.jpg",
    },
  ];
  ...
  return (
    <>
      <Head>
        <title>Ready to Revolutionize the Future of Fintech? | Decentro</title>
        <link rel="canonical" href={`https://decentro.tech/global/careers`} />
        <link
          rel="alternate"
          href="https://decentro.tech/global/careers"
          hreflang="x-default"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Ready to Revolutionize the Future of Fintech? | Decentro"
        />
