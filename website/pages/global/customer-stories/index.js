...
function CaseStudies() {
  ...
  const textAndButtonBannerData = {
    ctaTitle:
      '<span>Ready To Save Time, Resources, & Launch 10X Faster?</span><br/><div style="font-size: 12px">Let us help you! It’s as simple as it should be.</div>',
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Customer Success Stories | Decentro</title>
        <link
          rel="canonical"
          href="https://decentro.tech/global/customer-stories"
        />
        <link
          rel="alternate"
          href="https://decentro.tech/global/customer-stories"
        ...
        <meta
          property="og:title"
          content="Customer Success Stories | Decentro"
        />
      ...
      <div className="case-studies">
          ...
          <div className="inefficiency-contents">
            <div className="inefficiency-row-top">
              <div className="inefficiency-step">
                <div className="item">
                  <img src="/images/sg/customer-stories/connect.svg" />
                  <p>Your business requires a financial integration</p>
                </div>
              </div>
              <div className="step-arrow">
                <img src="/images/sg/customer-stories/step-arrow-right.svg" />
              </div>
              <div className="inefficiency-step">
                <div className="item">
                  <img src="/images/sg/customer-stories/transparency.svg" />
                  <p>
              ...
              <div className="inefficiency-step">
                <div className="item">
                  <img src="/images/sg/customer-stories/engineering.svg" />
                  <p>
            ...
            <div className="inefficiency-row-bottom">
              <div className="inefficiency-step">
                <div className="item">
                  <img src="/images/sg/customer-stories/problem.svg" />
                  <p>
              ...
              <div className="inefficiency-step">
                <div className="item">
                  <img src="/images/sg/customer-stories/thumbs-down.svg" />
              ...
              <div className="inefficiency-step">
                <div className="item">
                  <img src="/images/sg/customer-stories/bill.svg" />
        ...
        <div className="skip-loop">
              ...
              <div className="skip-loop-row">
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/craze.jpg"
                        alt="credit fair"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/shareplay.jpg"
                        alt="credit fair"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/pickrr.jpg"
                        alt="credit fair"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/credit-fair.png"
                        alt="credit fair"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/salary-se.png"
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/omnicard-case-study.jpeg"
                        alt="article image"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/ignosis-case-study.jpeg"
                        alt="article image"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/tramo-case-study.jpeg"
                        alt="article image"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/baya-case-study.jpeg"
                        alt="article image"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/vedfin-case-study.png"
                        alt="article image"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img
                        src="/images/sg/customer-stories/galgal-case-study.png"
                        alt="article image"
                      />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/alt-drx-case-study.png" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/dvara-case-study.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/Credit-Wise-Case-Study-2.jpg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/Leadoff-Case-Study.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/GyanDhan-Case-Study-1.jpg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/volopay-case-study.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/busybox-case-study.jpg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/Splitkaro-Case-Study.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/streamlining-credit-for-consumers-by-10x-with-moneytap.jpeg" />
                      <p>
            ...
            <div className="visible-content later">
              <div className="skip-loop-row">
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/Bimaplan-Case-Study.jpg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/FamPay-Case-Study.png" />
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/saraloan-case-study.jpg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/optimizing-instant-automotive-loans-for-kuwy.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/zerobalance-case-study.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/Zoozle-Case-Study.jpg" />
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/how-ocareneo-decentro-simplifies-healthtech-sector.jpg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/how-1bridge-streamlined-collections-reconciliation-decentro.jpeg" />
                      <p>
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/Gromo-Case-Study.jpg" />
                ...
                <div className="skip-loop-step">
                  ...
                  >
                    <div className="item">
                      <img src="/images/sg/customer-stories/fast-tracking-gig-economy-payments-for-workflexi-decentro.jpg" />
                      <p>
          ...
          >
            <img src="/images/sg/customer-stories/load-loading.gif" />
            <span>Load More</span>
          </button>
        </div>
              ...
              <div className="customer-block">
                <div className="customer-tale-video">
                  <iframe
                    width="1068"
                    height="597"
                    src="https://www.youtube.com/embed/ihju_4c_fic"
                    title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ...
                  <Link
                    className="secondary-yt-tab"
                    href="https://youtu.be/ihju_4c_fic"
                    target="_blank"
                  ></Link>
                </div>
              </div>
              ...
              <div className="customer-block">
                <div className="customer-tale-video">
                  <iframe
                    width="560"
                    height="597"
                    src="https://www.youtube.com/embed/hR-SxRsnPOI"
                    title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ...
                  <Link
                    className="secondary-yt-tab"
                    href="https://youtu.be/hR-SxRsnPOI"
                    target="_blank"
                  ></Link>
                </div>
              </div>
