...
const BBPS = () => {
  ...
  const [bannerData, setBannerData] = useState({
    heading: "<span class='highlighted-heading'>BBPS API</span>",
    tagline: "Fast and Secure Bill Collection System",
  ...
  const [tableOfContentsData, setTableOfContentsData] = useState([
    { text: "What is BBPS, & How Does it Work?", id: "introduction" },
    {
      text: "How To Make Payments Through Bharat Bill Pay?",
      id: "descriptiveFlowImage",
    },
    { text: "Need for BBPS", id: "needSection" },
    { text: "Where You Can Use It", id: "whereToUse" },
    {
      text: "BBPS via Neowise",
      id: "featureDescriptiveTextBlock",
    },
    {
      text: "Workflow via Neowise",
      id: "workflow",
    },
    {
      text: "BBPS and UPI APIs",
      id: "methodology",
    },
    {
      text: "Key Features Of BBPS API",
      id: "keyFeatures",
    },
    {
      text: "How can Neowise Help?",
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <link rel="alternate" href={metaData.canonical} hreflang="en-IN" />
      ...
      <div className={styles["phone-number-intelligence"]}>
        ...
        <div>
          ...
          {featureDescriptiveTextBlock && (
            <div id="featureDescriptiveTextBlock">
              <FeatureDescriptiveTextBlock data={featureDescriptiveTextBlock} />
            </div>
          )}

          {workflowData && (
            <div className="section-wrap" id="workflow">
              <h2 className="header-black-bold">
                Workflow&nbsp;<span>via Neowise</span>
              </h2>
              <MultiStepsDescription data={workflowData} />
            </div>
          )}
          ...
          {methodData && (
            ...
            >
              <h2>
                <span>BBPS and UPI APIs</span>
              </h2>

              <div
                className={styles["leverage-verifiction-api-content"]}
                style={{
                  width: "100%",
                }}
              >
