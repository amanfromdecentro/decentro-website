...
import styles from "../../styles/components-styles/descriptive-item-list-four/descriptive-item-list-four.module.scss";

const DescriptiveItemListFour = (props) => {
  return (
...
export default DescriptiveItemListFour;
