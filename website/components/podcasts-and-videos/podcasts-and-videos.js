...
const PodcastsAndVideos = (props) => {
  ...
  return (
    <div className="podcasts-and-videos">
      ...
      <p>
        Discover the latest from Decentro: press releases, media buzz, product
        enhancements, partnership reveals, and beyond.
      </p>
      ...
      <div className="podcasts-videos-contents">
        <div className="visible-content initial">
          <div className="podcasts-videos-row">
            <div className="podcasts-videos-step">
              <Link
                href="https://bfsi.eletsonline.com/decentro-unveils-indias-first-self-hosted-ckyc-solution-to-align-with-cersais-new-compliance-mandate/"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/bfsi.jpg" alt="cxo" />
                  <p>
                    Decentro Unveils India’s First Self-Hosted CKYC Solution to
                    Align with CERSAI’s New Compliance Mandate{" "}
                  </p>
                </div>
              </Link>
            </div>
            <div className="podcasts-videos-step">
              ...
              >
                <div className="item">
                  <img src="/images/press-buzz/neowise-debt.jpg" alt="cxo" />
                  <p>
                    Neowise Launches India’s First AI-Driven Debt Collection
                    SaaS Tools{" "}
                  </p>
                </div>
              </Link>
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://cxotoday.com/press-release/decentro-simplifies-recurring-payments-with-enach-and-upi-autopay-strengthening-indias-subscription-economy-ropes-in-yes-bank-as-its-first-partner-bank/"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/cxo_2024.jpg" alt="e27" />
                  <p>
                    YCombinator-Backed Decentro Unveils Modules To Streamline
                    Recurring Payments{" "}
                  </p>
                </div>
              </Link>
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://campaign.grantthornton.in/grant-thornton-bharat/thought-leadership-report/road-ahead-in-the-digital-era?_gl=1*14qcefn*_ga*MTM1OTI0MzMzNC4xNzIyNDk2MDEx*_ga_JLRBBJ6PTP*MTcyMjQ5NjAxMS4xLjAuMTcyMjQ5NjAxNy41Ni4wLjA.*_gcl_au*MTQ3MjUwNzcxNC4xNzIyNDk2MDE0"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/thorton_2024.jpg" alt="e27" />
                  <p>BFSI & Fintech Industry. Road Ahead in the Digital Era</p>
                </div>
              </Link>
            </div>
            <div className="podcasts-videos-step">
              <Link
                href="https://www.aninews.in/news/business/decentro-deepens-global-saas-offering-with-ledgers-for-automated-reconciliation20240808171101/"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/aninews_2024.jpg" alt="e27" />
                  <p>
                    Decentro Deepens Global SaaS Offering with Ledgers for
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://yourstory.com/smbstory/how-fintech-infrastructure-can-democratise-financial-services-msmes"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/smbstory.jpg" alt="e27" />
                  <p>
                    Tailored solutions, faster access: How fintech infra can
                    democratise financial services for MSMEs
                  </p>
                </div>
              </Link>
            </div>
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://bfsi.eletsonline.com/decentro-upgrades-its-digilocker-kyc-stack/"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/kyc-bfsi.jpg" alt="BFSI" />
                  <p>Decentro upgrades its DigiLocker & KYC Stack</p>
                </div>
              </Link>
            </div>
            ...
            <div className="podcasts-videos-step">
              ...
              >
                <div className="item">
                  ...
                  />
                  <p>
                    Decentro becomes the youngest fintech company to receive the
                    payment aggregator license from RBI.
                  </p>
                </div>
              </Link>
            </div>
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://bfsi.eletsonline.com/decentro-unveils-two-innovative-modes-for-bank-account-verification/"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
                <div className="item">
                  <img src="/images/press-buzz/2-modes.jpg" alt="BFSI" />
                  <p>
                    Decentro unveils two innovative modes for Bank Account
                    Verification
                  </p>
                </div>
              </Link>
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://www.youtube.com/embed/6kxqDEShoN4"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://www.youtube.com/embed/52PCZFlRdPM"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="visible-content later">
          <div className="podcasts-videos-row">
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://www.youtube.com/embed/642SEG5mNj8"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://www.youtube.com/embed/3RPlBbJdph8"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="podcasts-videos-step">
              <Link
                href="https://www.youtube.com/embed/fSS-FSDrm3Q"
                className="podcasts-videos-link"
                target="_blank"
                rel="noreferrer"
              >
