  ...
  return (
    <div className={styles["banner"]}>
      {/* <img
        ...
        alt="banner bg lines"
      /> */}
      {!props?.data?.DBackground && !props?.resourcePg && (
      ...
      <div className={styles["left-container"]}>
        ...
        {props?.data?.productLogo ? (
          <img src={props?.data?.productLogo} />
        ) : (
          ""
        )
        }
        ...
        {props.data.buttonDescription ? (
          <div className={styles["button-with-description"]}>
            <Link
        ...
        {props?.data?.leftImg && <img
          style={{ width: "130px", marginTop: "80px" }}
          src={props.data.leftImg}
          className="left-img"
          alt="Image on left describing page"
        />}
      ...
      <div className={styles["right-container"]}>
        {props.data.video ? (
          ...
          <Image
            priority={true}
            blurDataURL="/images/resources/professional-verification/professional-verification-banner.svg"
            placeholder="blur"
            layout="responsive"
            width={700}
            height={700}
