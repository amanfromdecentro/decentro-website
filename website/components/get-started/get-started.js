  ...
  return (
    <div className={styles["get-started"]}>
      ...
      <p className={styles["tagline"]}>
        Launch Financial Products <strong>10X faster</strong> using
      ...
      <div className={styles["get-started-steps"]}>
        ...
        <div className={styles["step-block"]}>
          <div className={styles["image-section"]}>
            <Image
              src="/images/icons/integrate.svg"
              alt="integrate icon"
              width={70}
              height={70}
            />
      ...
      <div className={styles["get-started-btn"]}>
        <Link href={requests.SIGNUP} target="_blank"
          rel="noopener noreferrer">Get Started</Link>
      </div>
    </div>
  );
};
